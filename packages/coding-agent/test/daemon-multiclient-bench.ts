...
const streamCorpus = repeatedText(STREAM_CHARS, "Dek Agent daemon multi-client streaming benchmark. ");
...
function printResults(
	...
	console.log("Dek Agent daemon multi-client benchmark");
	console.log(details);
	console.table(
		results.map((result) => ({
...
function printSessionLoad(sessionFile: string, result: SessionLoadResult): void {
	console.log("Dek Agent real-session benchmark");
