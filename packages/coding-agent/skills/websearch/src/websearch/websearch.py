...
def _agent_dir() -> Path:
    """Resolve the Dek Agent config dir the same way the runtime does."""
    raw = (
    ...
    *,
    ...
    if not api_key:
        return (
            ...
            "  2. In Dek Agent, run /login, switch to MCP Connections, choose \"Serper (web search)\", and paste the key.\n"
