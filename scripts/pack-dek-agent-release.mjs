...
// TODO: Remove this R2 tarball packer once dek-agent and its internal workspace
...
const publicPackageName = process.env.PRIME_AGENT_PACKAGE_NAME || "dek-agent";
const publicCommandName = process.env.PRIME_AGENT_CMD || "dek-agent";
const releaseChannels = new Set(["stable", "beta"]);

const releasePackages = [
	{ packageDir: "ai", publicName: undefined, artifactName: "dek-agent-ai" },
	{ packageDir: "tui", publicName: undefined, artifactName: "dek-agent-tui" },
	{ packageDir: "agent", publicName: undefined, artifactName: "dek-agent-core" },
...
Creates private npm tarballs for R2 distribution:
  ...
  <out-dir>/artifacts/dek-agent-<version>.tgz
  <out-dir>/artifacts/dek-agent-ai-<version>.tgz
  <out-dir>/artifacts/dek-agent-core-<version>.tgz
  <out-dir>/artifacts/dek-agent-tui-<version>.tgz
