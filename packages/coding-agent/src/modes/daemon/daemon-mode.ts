...
const UPDATE_RESTART_MARKER =
	...
	"Dek Agent was updated and intentionally interrupted this session. Continue from the saved transcript and restored tool/kernel state. Any running model, tool, bash, or child-agent work may have been partially completed.\n" +
	"</prime_agent_update_interrupted>";
...
export class AgentDaemon {
	...
	async start(): Promise<void> {
		...
		this.log(`Dek Agent daemon listening on ${this.socketPath}`);
