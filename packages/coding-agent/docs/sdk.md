> Dek Agent can help you use the SDK. Ask it to build an integration for your use case.

# SDK

The SDK provides programmatic access to Dek Agent's capabilities. Use it to embed Dek Agent in other applications, build custom interfaces, or integrate with automated workflows.
...
- If you omit `tools`, Dek Agent automatically creates them with the correct `cwd`
