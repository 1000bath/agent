...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "Dek Agent can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	},
	{
		...
		getText: () => "Dek Agent keeps IPython variables and helpers between turns and compactions.",
	},
	{
		id: "context-usage",
	...
	{
		id: "auto-compaction",
		getText: () => "Dek Agent automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "Dek Agent self-improves by refining skills, memories, prompts, and subagents.",
	},
	{
