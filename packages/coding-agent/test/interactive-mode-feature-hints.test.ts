...
describe("feature hint deck", () => {
	...
	it("covers Dek Agent workflows with capability-focused copy", () => {
		const deck = new FeatureHintDeck(() => 0);
		...
		expect(textById.get("subagents")).toBe("Dek Agent can delegate tasks to subagents and run them in parallel.");
